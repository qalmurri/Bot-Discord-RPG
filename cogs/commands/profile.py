                ...
                if player is None:
                    ...
                    if check is not None and check :
                        with Image.open("assets/rpg/profile/default.jpg") as a:
                            ...
                            if body_data :
                                body_name, body_class = (body_data.get(key, None) for key in ("name", "class"))
                                body_id, body_str, body_vit, body_int, body_agi, body_fire, body_water, body_wind, body_earth = (body_data.get(key, 0) for key in ("id_item", "str", "vit", "int", "agi", "fire", "water", "wind", "earth"))
                                a.paste(Image.open(f"assets/rpg/class/{body_class}.jpg").resize((281, 26)), (3, 235)) #Class
                                a.paste(Image.open(f"assets/rpg/item/body/{body_id}.png").resize((100, 142)), (384, 94)) #Thumbnail
                                a.paste(Image.open(f"assets/rpg/item/body/{body_id}.png").resize((16, 22)), (8, 237)) #Icon
                            ...
                            if gloves1_data :
                                gloves1_name, gloves1_class = (gloves1_data.get(key, None) for key in ("name", "class"))
                                gloves1_id, gloves1_str, gloves1_vit, gloves1_int, gloves1_agi, gloves1_fire, gloves1_water, gloves1_wind, gloves1_earth = (gloves1_data.get(key, 0) for key in ("id_item", "str", "vit", "int", "agi", "fire", "water", "wind", "earth"))
                                a.paste(Image.open(f"assets/rpg/class/{gloves1_class}.jpg").resize((281, 26)), (3, 263)) #Class
                                a.paste(Image.open(f"assets/rpg/item/gloves/{gloves1_id}.png").resize((100, 142)), (384, 94)) #Thumbnail
                                a.paste(Image.open(f"assets/rpg/item/gloves/{gloves1_id}.png").resize((16, 22)), (8, 237)) #Icon
                            ...
                            if gloves2_data :
                                gloves2_name, gloves2_class = (gloves2_data.get(key, None) for key in ("name", "class"))
                                gloves2_id, gloves2_str, gloves2_vit, gloves2_int, gloves2_agi, gloves2_fire, gloves2_water, gloves2_wind, gloves2_earth = (gloves2_data.get(key, 0) for key in ("id_item", "str", "vit", "int", "agi", "fire", "water", "wind", "earth"))
                                a.paste(Image.open(f"assets/rpg/class/{gloves2_class}.jpg").resize((281, 26)), (3, 291)) #Class
                                a.paste(Image.open(f"assets/rpg/item/gloves/{gloves2_id}.png").resize((100, 142)), (384, 94)) #Thumbnail
                                a.paste(Image.open(f"assets/rpg/item/gloves/{gloves2_id}.png").resize((16, 22)), (8, 237)) #Icon
                            ...
                            if belt_data :
                                belt_name, belt_class = (belt_data.get(key, None) for key in ("name", "class"))
                                belt_id, belt_str, belt_vit, belt_int, belt_agi, belt_fire, belt_water, belt_wind, belt_earth = (belt_data.get(key, 0) for key in ("id_item", "str", "vit", "int", "agi", "fire", "water", "wind", "earth"))
                                a.paste(Image.open(f"assets/rpg/class/{belt_class}.jpg").resize((281, 26)), (3, 319)) #Class
                                a.paste(Image.open(f"assets/rpg/item/belt/{belt_id}.png").resize((100, 142)), (384, 94)) #Thumbnail
                                a.paste(Image.open(f"assets/rpg/item/belt/{belt_id}.png").resize((16, 22)), (8, 237)) #Icon
                            ...
                            if ring1_data :
                                ring1_name, ring1_class = (ring1_data.get(key, None) for key in ("name", "class"))
                                ring1_id, ring1_str, ring1_vit, ring1_int, ring1_agi, ring1_fire, ring1_water, ring1_wind, ring1_earth = (ring1_data.get(key, 0) for key in ("id_item", "str", "vit", "int", "agi", "fire", "water", "wind", "earth"))
                                a.paste(Image.open(f"assets/rpg/class/{ring1_class}.jpg").resize((281, 26)), (3, 347)) #Class
                                a.paste(Image.open(f"assets/rpg/item/ring/{ring1_id}.png").resize((100, 142)), (384, 94)) #Thumbnail
                                a.paste(Image.open(f"assets/rpg/item/ring/{ring1_id}.png").resize((16, 22)), (8, 237)) #Icon
                            ...
                            if ring2_data :
                                ring2_name, ring2_class = (ring2_data.get(key, None) for key in ("name", "class"))
                                ring2_id, ring2_str, ring2_vit, ring2_int, ring2_agi, ring2_fire, ring2_water, ring2_wind, ring2_earth = (ring2_data.get(key, 0) for key in ("id_item", "str", "vit", "int", "agi", "fire", "water", "wind", "earth"))
                                a.paste(Image.open(f"assets/rpg/class/{ring2_class}.jpg").resize((281, 26)), (3, 375)) #Class
                                a.paste(Image.open(f"assets/rpg/item/ring/{ring2_id}.png").resize((100, 142)), (384, 94)) #Thumbnail
                                a.paste(Image.open(f"assets/rpg/item/ring/{ring2_id}.png").resize((16, 22)), (8, 237)) #Icon
                            ...
                            if pants_data :
                                pants_name, pants_class = (pants_data.get(key, None) for key in ("name", "class"))
                                pants_id, pants_str, pants_vit, pants_int, pants_agi, pants_fire, pants_water, pants_wind, pants_earth = (pants_data.get(key, 0) for key in ("id_item", "str", "vit", "int", "agi", "fire", "water", "wind", "earth"))
                                a.paste(Image.open(f"assets/rpg/class/{pants_class}.jpg").resize((281, 26)), (3, 403)) #Class
                                a.paste(Image.open(f"assets/rpg/item/pants/{pants_id}.png").resize((100, 142)), (384, 94)) #Thumbnail
                                a.paste(Image.open(f"assets/rpg/item/pants/{pants_id}.png").resize((16, 22)), (8, 237)) #Icon
                            ...
                            if hand1_data :
                                hand1_name, hand1_class = (hand1_data.get(key, None) for key in ("name", "class"))
                                hand1_id, hand1_str, hand1_vit, hand1_int, hand1_agi, hand1_fire, hand1_water, hand1_wind, hand1_earth = (hand1_data.get(key, 0) for key in ("id_item", "str", "vit", "int", "agi", "fire", "water", "wind", "earth"))
                                a.paste(Image.open(f"assets/rpg/class/{hand1_class}.jpg").resize((281, 26)), (3, 431)) #Class
                                a.paste(Image.open(f"assets/rpg/item/hand/{hand1_id}.png").resize((100, 142)), (384, 94)) #Thumbnail
                                a.paste(Image.open(f"assets/rpg/item/hand/{hand1_id}.png").resize((16, 22)), (8, 237)) #Icon
                            ...
                            if hand2_data :
                                hand2_name, hand2_class = (hand2_data.get(key, None) for key in ("name", "class"))
                                hand2_id, hand2_str, hand2_vit, hand2_int, hand2_agi, hand2_fire, hand2_water, hand2_wind, hand2_earth = (hand2_data.get(key, 0) for key in ("id_item", "str", "vit", "int", "agi", "fire", "water", "wind", "earth"))
                                a.paste(Image.open(f"assets/rpg/class/{hand2_class}.jpg").resize((281, 26)), (3, 459)) #Class
                                a.paste(Image.open(f"assets/rpg/item/hand/{hand2_id}.png").resize((100, 142)), (384, 94)) #Thumbnail
                                a.paste(Image.open(f"assets/rpg/item/hand/{hand2_id}.png").resize((16, 22)), (8, 237)) #Icon
                            ...
                            if boots_data :
                                boots_name, boots_class = (boots_data.get(key, None) for key in ("name", "class"))
                                boots_id, boots_str, boots_vit, boots_int, boots_agi, boots_fire, boots_water, boots_wind, boots_earth = (boots_data.get(key, 0) for key in ("id_item", "str", "vit", "int", "agi", "fire", "water", "wind", "earth"))
                                a.paste(Image.open(f"assets/rpg/class/{boots_class}.jpg").resize((281, 26)), (3, 487)) #Class
                                a.paste(Image.open(f"assets/rpg/item/boots/{boots_id}.png").resize((100, 142)), (384, 94)) #Thumbnail
                                a.paste(Image.open(f"assets/rpg/item/boots/{boots_id}.png").resize((16, 22)), (8, 237)) #Icon
                            ...
                            stats_atk = stats_agi*(1+(2/100))+stats_str*(1+(4/100))
                            stats_aspd = 10
                            stats_def = 10
                            stats_mdef = 10
                            stats_matk = 10
