                    ...
                    if check is not None and check :
                        with Image.open("assets/rpg/profile/default.jpg") as a:
                            ...
                            if gloves1_data :
                                ...
                                a.paste(Image.open(f"assets/rpg/item/gloves/{gloves1_id}.png").resize((80, 111)), (295, 164)) #Thumbnail
                                a.paste(Image.open(f"assets/rpg/item/gloves/{gloves1_id}.png").resize((16, 22)), (8, 265)) #Icon
                            ...
                            if gloves2_data :
                                ...
                                a.paste(Image.open(f"assets/rpg/item/gloves/{gloves2_id}.png").resize((80, 111)), (491, 164)) #Thumbnail
                                a.paste(Image.open(f"assets/rpg/item/gloves/{gloves2_id}.png").resize((16, 22)), (8, 293)) #Icon
                            ...
                            if belt_data :
                                ...
                                a.paste(Image.open(f"assets/rpg/item/belt/{belt_id}.png").resize((98, 40)), (384, 243)) #Thumbnail
                                a.paste(Image.open(f"assets/rpg/item/belt/{belt_id}.png").resize((22, 10)), (5, 327)) #Icon
                            ...
                            if ring1_data :
                                ...
                                a.paste(Image.open(f"assets/rpg/item/ring/{ring1_id}.png").resize((50, 50)), (310, 280)) #Thumbnail
                                a.paste(Image.open(f"assets/rpg/item/ring/{ring1_id}.png").resize((22, 22)), (5, 349)) #Icon
                            ...
                            if ring2_data :
                                ...
                                a.paste(Image.open(f"assets/rpg/item/ring/{ring2_id}.png").resize((50, 50)), (505, 280)) #Thumbnail
                                a.paste(Image.open(f"assets/rpg/item/ring/{ring2_id}.png").resize((22, 22)), (5, 377)) #Icon
                            ...
                            if pants_data :
                                ...
                                a.paste(Image.open(f"assets/rpg/item/pants/{pants_id}.png").resize((80, 111)), (393, 287)) #Thumbnail
                                a.paste(Image.open(f"assets/rpg/item/pants/{pants_id}.png").resize((16, 22)), (8, 405)) #Icon
                            ...
                            if hand1_data :
                                ...
                                a.paste(Image.open(f"assets/rpg/item/hand/{hand1_id}.png").resize((80, 111)), (295, 335)) #Thumbnail
                                a.paste(Image.open(f"assets/rpg/item/hand/{hand1_id}.png").resize((16, 22)), (8, 433)) #Icon
                            ...
                            if hand2_data :
                                ...
                                a.paste(Image.open(f"assets/rpg/item/hand/{hand2_id}.png").resize((80, 111)), (491, 335)) #Thumbnail
                                a.paste(Image.open(f"assets/rpg/item/hand/{hand2_id}.png").resize((16, 22)), (8, 461)) #Icon
                            ...
                            if boots_data :
                                ...
                                a.paste(Image.open(f"assets/rpg/item/boots/{boots_id}.png").resize((80, 111)), (393, 402)) #Thumbnail
                                a.paste(Image.open(f"assets/rpg/item/boots/{boots_id}.png").resize((16, 22)), (8, 489)) #Icon
